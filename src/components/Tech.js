...
export default function Tech() {
    return (
        <div className={tech}>
            <h1>Techonlogies I'm familiar with</h1>
            <div className={techGrid}>
                ...
                <div>
                    <box-icon type='logo' name='typescript' size="lg" color="#007acc"></box-icon>
                    <p>TypeScript</p>
                </div>
                <div>
                ...
                <div>
                    <box-icon name='vuejs' type='logo' size="lg"></box-icon>
                    <p>Vue.Js</p>
                </div>
                <div>
                    <box-icon name='go-lang' type='logo' size="lg" color="#00ADD8"></box-icon>
                    <p>Golang</p>
                </div>
                <div>
                    <box-icon name='postgresql' type='logo' size="lg"></box-icon>
                    <p>Postgresql</p>
                </div>
                <div>
                    <box-icon type='logo' name='apple' size="lg" color="#ffffff"></box-icon>
                    <p>Swift</p>
                </div>
            </div>        
        </div>
